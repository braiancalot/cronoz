// `runningShift` is half the meta line's height: the meta keeps its space while
// running, and the digits drift down into it, so nothing below the timer moves.
export const SIZES = {
  default: {
    gap: "gap-2",
...
export const FLUID = {
  gap: "gap-[clamp(0.15rem,1.25vmin,0.5rem)]",
