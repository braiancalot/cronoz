...
export function TimerControls({
  ...
  return (
    <div className="flex w-full pb-8 gap-4 items-center justify-center">
      {!isRunning && hasTime && (
        <button
          className="px-5 py-2 min-w-20 border border-neutral-600 outline-hidden text-white rounded-lg text-sm transition-all hover:bg-neutral-900 active:scale-95 active:bg-neutral-700"
          onClick={onReset}
        >
          Reset
        </button>
